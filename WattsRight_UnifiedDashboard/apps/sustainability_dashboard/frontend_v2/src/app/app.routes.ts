...
export const routes: Routes = [
  ...
  { path: 'loading-upload', component: UploadLoaderComponent },
  { path: 'pruning-adjustments', component: PruningAdjustmentsComponent },
  { path: 'loading-benchmark', component: BenchmarkLoaderComponent },
  {
    path: 'benchmark-results',
    component: BenchmarkResultsComponent,
    resolve: { benchmark: BenchmarkResolver } // 👈 waits for backend
  },
];
